...
[ ! -e "$DOLLAR_MARKER" ]
printf '%s\n' "Makefile root tests passed: 77 executed target/authority cases, 2 MAKEFILE_LIST rejections, 1 detected MAKEFILES preload startup, 2 multi-Makefile rejections, and 1 dollar-path fail-closed case"
